        ...
        static void Main(string[] args)
        {
            ...
            var preprocessingPipeline = mlContext.Transforms.Conversion
                    ...
                    .Append(mlContext.Transforms.LoadRawImageBytes(
                        ...
                        imageFolder: datasetPath, // Path induk untuk semua gambar
            ...
            var trainingPipeline = mlContext.MulticlassClassification.Trainers
                    .ImageClassification(new ImageClassificationTrainer.Options
                    {
                        ...
                        Arch = ImageClassificationTrainer.Architecture.ResnetV2101, // Menggunakan ResNet
                        Epoch = 10,
                        BatchSize = 10,
                        LearningRate = 0.01f,
                        MetricsCallback = (metrics) => Console.WriteLine(metrics),
                        ValidationSet = preprocessedTestData // Menggunakan data tes sebagai set validasi
                    })
...
// Fungsi helper untuk memuat path gambar dan label dari folder
        static IEnumerable<ImageData> LoadImagesFromDirectory(string folder)
        {
            var files = Directory.GetFiles(folder, "*", SearchOption.AllDirectories);
            foreach (var file in files)
            {
                // Labelnya adalah nama folder induk (misal: 'cardboard', 'glass')
